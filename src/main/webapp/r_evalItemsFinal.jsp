...
//        System.out.println("nombre = " + nombre);
    ...
    List<PnCuantitativa> cuantitativas;
//    cuantitativas = pnManager.getCuantitativaConsensoFromEmpleado(empleado.getIdEmpleado());
    cuantitativas = pnManager.getCuantitativaDespuesVisitaFromEmpleado(empleado.getIdEmpleado());

    List<MyKey> totalesItems = pnManager.getTotalesItems(empleado.getIdEmpleado(), 5);
